                	...
                	<tr>
                     ...
                     <tr>
						...
						<br/><br/>
                          ...
                          <tr>
                   <form name="exam_results_by_exam_type" method="post" action="<?php echo base_url(); ?>index.php/welcome/get_results_by_class">
						  	<td>Select Class:</td>
								<td>
								 <select name="class">
					 ...
					 <td>Class:</td><td colspan="1"><?php echo $res[0]['class'];?> - <?php echo $res[0]['division'];?> </td>
					  <td>Exam Type</td><td colspan="1"><?php echo $res[0]['exam_type'];?></td>
					 </tr>
