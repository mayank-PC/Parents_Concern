                    	...
                    	<td>
                        	<table align="center" cellpadding="4" cellspacing="5" border="0" width="100%">
							   ...
							   <?php foreach($res as $row){?>
                                <form name="add_attendence" method="post" action="<?php echo base_url(); ?>index.php/welcome/edit_timetable">
								<br/>
								<br/><br/><br/><br/>
								...
								<tr>
                                	<th>Topic</th>
									<td><input type="text" name="topic" value="<?php echo $row['topic']; ?>" required></td>

                                </tr>

								<tr>
                                	<th>Activity Type</th>
									<td><input type="text" name="activity_type" value="<?php echo $row['activity_type']; ?>" required></td>

                                </tr>

								<tr>
                                	<th>Faculty</th>
									<td><input type="number" name="faculty" value="<?php echo $row['faculty']; ?>"></td>
                                </tr>
